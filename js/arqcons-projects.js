...
const footer = `<footer class="home-footer-white bg-nero-grey pb-0 pt-4 md-pt-6 sm-pt-9 xs-pt-11 background-position-center-top" style="background-image:url('images/demo-architecture-dotted-pattern.svg')"><div class="container"><div class="row align-items-center mb-3 md-mb-5 xs-mb-8"><div class="col-sm-10 text-center text-sm-start order-2 order-sm-1"><h6 class="text-white fw-400 d-inline-block align-middle mb-0">Construyamos algo <span class="text-white">increíble juntos</span></h6><div class="separator-line-1px d-none d-sm-inline-block align-middle ms-20px me-20px lg-ms-10px lg-me-10px mt-5px w-70px lg-w-50px bg-base-color"></div><a href="mailto:arqcons.arquitectura@gmail.com" class="text-base-color fs-26 fw-500 d-inline-block align-middle">arqcons.arquitectura@gmail.com</a></div><div class="col-sm-2 text-center text-sm-end order-1 order-sm-2 xs-mb-15px"><a href="home.html" class="footer-logo d-inline-block"><img src="images/Logo/logo.png" data-at2x="images/Logo/logo.png" alt="ArqCons"></a></div></div><div class="row align-items-start mb-6 xs-mb-9"><div class="col-md-4 last-paragraph-no-margin text-center text-sm-start md-mb-30px"><span class="section-label text-base-color d-block fw-600 text-uppercase">Ubicación</span><p class="w-80 lg-w-95 md-w-70 sm-w-85 xs-mx-auto text-white fs-15 lh-28">Av. Caamaño 1370, Vohe Studios, Estudio 209, Pilar, Buenos Aires, Argentina</p></div><div class="col-md-4 last-paragraph-no-margin text-center text-sm-start md-mb-30px"><span class="section-label text-base-color d-block fw-600 text-uppercase">Teléfono</span><p class="w-80 lg-w-95 md-w-70 sm-w-85 xs-mx-auto text-white fs-15 lh-28"><a href="tel:+5491149975060" class="text-white">+54 9 11 4997-5060</a></p></div><div class="col-md-4 last-paragraph-no-margin ms-auto text-center text-sm-start text-lg-end fs-19"><span class="section-label text-base-color d-block fw-600 text-uppercase mb-10px">Hablemos de tu proyecto</span><a href="contacto.html" class="text-white fw-500 text-decoration-line-bottom">Contactanos</a></div></div></div><div class="footer-bottom p-20px border-top border-color-transparent-white-light"><div class="container"><div class="row align-items-center"><div class="col-lg-7 text-center text-lg-start md-mb-10px"><ul class="footer-navbar fs-15 lh-normal"><li class="nav-item"><a href="home.html" class="nav-link">Inicio</a></li><li class="nav-item"><a href="about.html" class="nav-link">Nosotros</a></li><li class="nav-item"><a href="servicios.html" class="nav-link">Servicios</a></li><li class="nav-item"><a href="proyectos.html" class="nav-link">Residencias</a></li><li class="nav-item"><a href="emprendimientos.html" class="nav-link">Emprendimientos</a></li><li class="nav-item"><a href="contacto.html" class="nav-link">Contacto</a></li></ul></div><div class="col-lg-5 text-center text-lg-end"><span class="fs-15">&copy; 2026 ArqCons. Todos los derechos reservados. Desarrollado por <a href="https://estudiohs.com.ar/" target="_blank" rel="noopener noreferrer" class="section-label text-base-color fw-600 text-uppercase">HEMISFERIO SUR</a></span></div></div></div></div></footer><div class="scroll-progress d-none d-xxl-block"><a href="#" class="scroll-top" aria-label="Volver al inicio"><span class="scroll-text">Subir</span><span class="scroll-line"><span class="scroll-point"></span></span></a></div>`;
    ...
    const projects = {
        ...
        "proyecto-reserva-iv.html": { title: "La Reserva Cardales", folder: "Casa Reserva IV" },
        "proyecto-puertos-del-lago.html": { title: "Puertos del Lago", folder: "Casa en Puertos del Lago" },
        "proyecto-san-eliseo.html": { title: "San Eliseo", folder: "Casa San Eliseo" },
        "proyecto-san-isidro-labrador.html": { title: "San Isidro Labrador", folder: "Casa San Isidro Labrador" },
        "proyecto-estancias-del-pilar.html": { title: "Estancias del Pilar", folder: "Casa Estancias del Pilar" },
        "proyecto-reserva-iii.html": { title: "La Reserva Cardales", folder: "Casa Reserva III" },
        "proyecto-reserva-ii.html": { title: "La Reserva Cardales", folder: "Casa Reserva II", image: "images/proyectos/Casa Reserva II/Sbarbatti Cardales 009.webp" },
        "emprendimiento-boulevard-del-sol.html": { title: "Boulevard del Sol", image: "images/Emprendimientos/Boulevard del Sol/b1.webp" },
        "emprendimiento-chateau-pilar.html": { title: "Chateau Pilar", image: "images/Emprendimientos/Chateau Pilar/ch1.webp" },
        "emprendimiento-habitat-residencias.html": { title: "Hábitat Residencias", image: "images/Emprendimientos/Habitat Residencias/h1.webp" },
        "emprendimiento-palmas-del-sol.html": { title: "Palmas del Sol", image: "images/Emprendimientos/Palmas Del Sol/p1.webp" }
    };
    ...
    /* Video preview and in-page player. The original YouTube link remains as a fallback when JavaScript is unavailable. */
    const videoLink = document.querySelector('a[href*="youtube.com/watch"], a[href*="youtu.be/"]');
    if (videoLink) {
        ...
        if (videoId) {
            videoLink.id = "project-video";
            videoLink.className = "project-video-card";
            videoLink.setAttribute("aria-label", "Reproducir video del proyecto");
            videoLink.style.setProperty("--project-video-poster", `url("${heroImage}")`);
            videoLink.innerHTML = `<span class="project-video-shade"></span><span class="project-video-copy"><span class="section-label">Experiencia audiovisual</span><strong>Conocé el emprendimiento en video</strong><span class="project-video-action"><i class="fa-solid fa-play" aria-hidden="true"></i><span>Reproducir video</span></span></span>`;

            const videoModal = document.createElement("div");
            videoModal.className = "project-video-modal";
            videoModal.setAttribute("role", "dialog");
            videoModal.setAttribute("aria-modal", "true");
            videoModal.setAttribute("aria-label", "Video del emprendimiento");
            videoModal.innerHTML = `<button class="project-video-close" type="button" aria-label="Cerrar video">&times;</button><div class="project-video-frame"><iframe title="Video del emprendimiento" allow="autoplay; encrypted-media; picture-in-picture" allowfullscreen></iframe></div>`;
            document.body.append(videoModal);
            const frame = videoModal.querySelector("iframe");
            const closeButton = videoModal.querySelector(".project-video-close");
            ...
            videoModal.addEventListener("click", function (event) { if (event.target === videoModal) closeVideo(); });
    ...
    document.querySelectorAll("[data-project-gallery]").forEach(function (gallery) {
        ...
        const root = gallery.dataset.galleryRoot || "images/proyectos";
        const count = Number(gallery.dataset.count || 0);
        const title = gallery.dataset.title || "Proyecto ArqCons";
        const files = (gallery.dataset.files || "").split("|").filter(Boolean);
        images = files.length
    ...
    if (galleryItems.length) {
        ...
        galleryItems.forEach(function (item) { item.addEventListener("pointerenter", function () { cursor.classList.add("is-active"); }); item.addEventListener("pointerleave", function () { cursor.classList.remove("is-active"); }); });
    }
    ...
    if (oldNav && oldNav.querySelectorAll("a").length === 2) {
        ...
        nav.innerHTML = links.map(function (link, index) {
            ...
            if (!project) return "";
            const image = project.image || `images/proyectos/${project.folder}/1.webp`;
            return `<a href="${file}" class="project-nav-card"><img src="${image}" alt="" loading="lazy" decoding="async"><span class="project-nav-content"><span class="project-nav-label">${index === 0 ? "Proyecto anterior" : "Proyecto siguiente"}</span><span class="project-nav-title">${project.title}</span></span></a>`;
        }).join("");
